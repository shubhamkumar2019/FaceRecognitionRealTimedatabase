...
app = Flask(__name__, template_folder=os.path.abspath(
    "C:\\Users\\KIIT\\PycharmProjects\\FaceRecognitionRealTimeDatabase\\template"))  # Update path if needed
...
predictor = dlib.shape_predictor("shape_predictor_68_face_landmarks.dat")  # Download and place in project root

# Attendance throttling
last_update_times = {}
...
def recognize_faces():
    ...
    if not detect_blink(frame):
        return jsonify({"error": "Liveness detection failed (no blink detected)."}), 403
